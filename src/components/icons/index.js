...
export const ubuntuIcon = (
  <i>
    <FontAwesomeIcon icon={["fab", "ubuntu"]} />
  </i>
)
...
export const wordPressIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "wordpress"]} />
  </i>
)
export const htmlIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "html5"]} />
  </i>
)
export const cssIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "css3-alt"]} />
  </i>
)
export const phpIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "php"]} />
  </i>
)
export const adroidIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "android"]} />
  </i>
)
export const symfonyIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "symfony"]} />
  </i>
)
export const jsIcone = (
  <i>
    <FontAwesomeIcon icon={["fab", "js"]} />
  </i>
)
export const angularIcone = (
  <i>
...
export const mailIcon = (
  <i>
    <FontAwesomeIcon icon={["fas", "mail-bulk"]} />
  </i>
)
