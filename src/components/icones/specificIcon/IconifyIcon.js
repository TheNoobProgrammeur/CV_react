...
import kotlinIcone from '@iconify-icons/cib/kotlin';
...
const flask= <i><Icon icon={flaskIcon} /></i>
const graphql= <i><Icon icon={graphqlIcon} /></i>
const spring= <i><Icon icon={springIcon} /></i>
const kotlin= <i><Icon icon={kotlinIcone} /></i>
